...
const registerStaff = async (req, res) => {
  try {
    ...
    await sendEmail({
      ...
      html: `<p>Your account has been created successfully. Your password is: <b>${password}</b></br> Reset your password after logged in</p>`,
    });
    ...
    res
      .status(201)
      .json({ message: "Staff registered successfully", savedStaff });
  } catch (error) {
